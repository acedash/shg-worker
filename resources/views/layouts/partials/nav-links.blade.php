<nav class="nav-links">
    ...
    @if (! auth()->user()->isAdmin())
        ...
        <a class="nav-link {{ request()->routeIs('worker.submissions') || request()->routeIs('worker.reports.daily') ? 'active' : '' }}" href="{{ route('worker.submissions', ['month' => now()->format('Y-m')]) }}">Reports</a>
    @endif
</nav>
